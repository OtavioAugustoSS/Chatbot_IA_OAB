...
app = FastAPI(
    title="OAB Bot API",
    description="Motor de conversação de WhatsApp para preparação OAB usando NVIDIA NIM (Llama 3.1 70B) e FastAPI"
)
...
@app.get("/")
def read_root():
    return {"status": "Online", "mensagem": "API do Bot OAB rodando perfeitamente!"}
